...
//   }
  ...
  /* Ó³Éä±íË÷Òý: 0~12, Keil Watch Àï¸Ä, ÎÞÐèÖØÐÂ±àÒë */
  volatile int hall_table_index = 12;

  /* 13 ÖÖÓ³Éä: 0~5Í¬Ïò, 6~11·´Ïò, 12¿ª»·Êµ²âÐ£Õý */
  static const uint8_t hall_tables[14][8] = {
      ...
      {0xFF, 5, 1, 0, 3, 4, 2, 0xFF},   /* 13: CCW¡ústepµÝÔö [0x03¡ú0,0x01¡ú5,0x05¡ú4,0x04¡ú3,0x06¡ú2,0x02¡ú1] */
  };
